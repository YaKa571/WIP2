            ...
            dbc.Row(
                dbc.Col(
                    [
                        ...
                        comp_factory.create_data_table("table1",data_frame_users , visible=True),
                        comp_factory.create_data_table("table3", data_frame_cards, visible=True),

                        # first 100.000 rows of transactions_data as table
