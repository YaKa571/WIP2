...
@callback(
    ...
    Input(ID.CLUSTER_CONTROL_MERCHANT_GROUP_DROPDOWN,'value'),
)
def update_cluster_new(n_transactions, n_value, n_inc_vs_exp,n_all_ages,n_age_groups, selected_merchant_group):
